		...
		<tr>
          <td align="center"  >
          	<table width="50%" style="background-color: #95F5B6;">
          		<tr>
          			<td align="center" colspan="2">
          				<input type="text" placeholder="Nombre" name="NOMBRE" id= "idnombre" value="<?php echo $varnom ?>" maxlength="100" size="25" required>
          			</td>
          		</tr>
          		<tr>
          			<td align="center" colspan="2">
            ...
            <input type="email" name="CORREO" placeholder="Correo" id="idCorreo" value="<?php echo $varcorreo ?>" maxlength="100" size= "30" required>
                     ...
                     <tr>
                         <td align="center" colspan="2">
                  <input type="number" name="TELEFONO" placeholder="Teléfono" id="idTelefono" value="<?php echo $vartelefono ?>" maxlength="11" size= "13" required> 
                         </td>
                    </tr>  
                   <tr>
                    <td align="center" >
