      ...
      if($row = $Conexion->GetRows($result)){
        session_start();
          ...
          <script type="text/javascript">
            self.location = "../PROFESORES/Consulta.php";
          </script>               
            <?php
          }else{
        ...
        <div>
          <ul>
           <li ><a class="titulo verde" >Alumnos</a></li>
            <li class="titulo rojo"><a href="InSecionAlum.php">Iniciar Sesión</a></li>
          </ul>
            <ul>
...
<form action="" method="post" > 
  <h1 style="color: white;" align="center">Profesores</h1>  
          ...
          <td align="center"  >
            ...
            <input type="email" name="Correo" placeholder="Correo" id="idCorreo" value="" maxlength="100" size= "30" required>
                 ...
                 <td align="right" colspan="2">
                    <a href="../PROFESORES/REGISTRO/insert.php">Registrate Aqui</a> 
                   </td> 
                     </tr> 
